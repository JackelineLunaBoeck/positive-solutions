...
export default {
    ...
    methods: {
              ...
              db.collection(this.collection).doc(this.current).collection(this.collection_det)
                .onSnapshot((snapshotChange) => {  
                    snapshotChange.forEach((doc) => {
                        ...
                        this.totalProductos = Number(this.totalProductos) + (Number(doc.data().precio)*Number(doc.data().cantidad)) - Number(doc.data().descuento)
        ...
        onFormSubmit_det(){
            ...
            //FuncionesDB.stock(this.data_det.sku, this.data_det.cantidad, "down")
